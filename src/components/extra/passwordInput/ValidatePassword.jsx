...
//       : undefined,
//     fontFamily: fontFamily || undefined || "Poppins,san-serif",
//   };

//   const labelStyle = {
//     position: "absolute",
//     left: "10px",
//     top: isFocused || value ? "0%" : "20%",
...
const ValidatePassword = ({
  ...
  // New useEffect to update error state based on passwordsMatch
  useEffect(() => {
  ...
  }, [showMismatchError, value, errorMessage]);
  ...
  const getStrengthColor = (strength, index) => {
    // If the passwords do not match, return red for all bars
    if (showMismatchError) {
      return "#e74c3c";
    }
